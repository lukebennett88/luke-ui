...
| Playground editor and skeleton                | `components/playground/{editor,editor-skeleton,editor-skeleton-script,monaco-format}.ts*`, `lib/monaco-setup.ts` | none                                                                        | editor shell/skeleton classes                                     | Monaco CSS/themes, Catppuccin, `fd-*` pill; format/hash/shape logic in `@luke-ui/playground-core`, Monaco registration in docs `monaco-format.ts` (#671) | Monaco completion/format, pre-hydration skeleton, loading            | Local UI + Structure            | Keep Monaco; move host/skeleton styles to `.css.ts`                                                     | #669, #671             | #676       |
