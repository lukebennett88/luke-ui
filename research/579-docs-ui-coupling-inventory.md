...
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------- | ---------- |
| Root document and providers                   | `src/routes/__root.tsx`, `src/components/theme-controls.tsx`                                              | `RootProvider`, search dialog type                                          | body/root layout classes                                          | `app.css`, Luke UI root and theme stylesheet URLs, `text-fd-foreground` | SSR/hydration, colour mode, theme identity, spritesheet, lazy search | Existing + Structure            | Keep Luke UI theme/spritesheet; isolate or replace visual provider ownership, use `.css.ts`             | #669                   | #672       |
