...
import { sizeStyles, styles } from './recipe.js';
...
export function IconButton(props: IconButtonProps): JSX.Element {
	...
	return (
		<Button
			...
			isPending={isPending}
			size={size}
			xstyle={[styles.reset, sizeStyles[size], xstyle]}
		>
			<Icon aria-hidden name={icon} xstyle={isPending ? styles.iconPending : undefined} />
		</Button>
	);
}
