export { kbdRecipe, type KbdRecipeVariants } from './recipe.css.js';
import * as styles from '../kbd/recipe.css.js';
...
export function Kbd(props: KbdProps) {
	...
	return <kbd {...elementProps} className={cx(styles.kbdRecipe(), className)} />;
}
