...
export const selectInputText = recipeInLayer('recipes', {
	base: {
		appearance: 'none',
...
export const selectTrigger = recipeInLayer('recipes', {
	base: {
		alignItems: 'center',
		appearance: 'none',
		backgroundColor: vars.backgroundColor.input,
...
export const selectValue = recipeInLayer('recipes', {
	base: {
		color: vars.foregroundColor.primary,
		overflow: 'hidden',
		textAlign: 'start',
		...
		selectors: {
			...
			'button:where([data-disabled="true"], :disabled) &': {
				color: vars.foregroundColor.disabled,
			},
		},
	},
...
export const selectPopover = recipeInLayer('recipes', {
	base: {
...
export const selectListBox = recipeInLayer('recipes', {
	base: {
...
export const selectSection = recipeInLayer('recipes', {
	base: {
...
export const selectSectionHeading = styleInLayer('recipes', {
	color: vars.foregroundColor.secondary,
	fontSize: vars.font.size.small,
...
export const selectItem = recipeInLayer('recipes', {
	base: {
		alignItems: 'center',
		borderRadius: vars.borderRadius.medium,
		color: vars.foregroundColor.primary,
