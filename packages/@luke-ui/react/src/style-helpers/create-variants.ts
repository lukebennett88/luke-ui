...
export function createVariants<Key extends string, Style extends Record<string, StylePrimitive>>(
...
export function createPropertyVariants<Key extends string, Property extends string>(
	keys: ReadonlyArray<Key>,
	property: Property,
