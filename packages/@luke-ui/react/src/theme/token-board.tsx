...
// Capped at the contract's deepest group (color.intent.<role>.surface.<state>, 4 levels above the
 ...
 * pair in `recipes/text.css.ts`; a plain swatch cannot show a margin, so this applies the trim
