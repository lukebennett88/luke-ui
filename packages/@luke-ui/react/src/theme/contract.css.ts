 ...
 * `--luke-*` variable reference, for example `vars.color.background.danger.solid.rest` is
 * `var(--luke-color-background-danger-solid-rest)`. Emits no CSS; values are supplied by a
