...
const meta = preview.meta({
	component: ThemeDiagnosticsInspector,
	tags: ['theme'],
...
export const Inspector = meta.story({
	play: async ({ canvas }) => {
		...
		const paperOption = canvas.getByRole('radio', { name: 'paper' });
		await userEvent.click(paperOption);
		await expect(paperOption).toBeChecked();
	},
});

function ThemeDiagnosticsInspector() {
