 ...
 * Pass semantic variable references such as `vars.radius.control` and `vars.space.sp8` so the
 ...
 * references such as `vars.radius.surface` and `vars.space.sp12` so the result follows the
 * active theme.
 */
