			...
			expect(summary).toEqual(
				(['light', 'dark'] as const).map((mode) => ({
					...
					interactionForegrounds: [
						...
						'color.text.primary',
						'hover of color.foreground.accent.default',
						'hover of color.foreground.danger.default',
						'hover of color.text.primary',
						'pressed of color.foreground.accent.default',
						'pressed of color.foreground.danger.default',
						'pressed of color.text.primary',
					],
