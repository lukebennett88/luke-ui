...
`.artifacts/visual-regression/report/index.html`. Capture identity, harness files, and that
artifact directory are defined in `packages/@luke-ui/react/src/test-utils/visual-capture-id.ts` and
