...
Keep each description to one sentence. Repeat necessary instructions in the error message because
the description disappears when the field becomes invalid.
