...
Read [Contrast validation](/theming/authoring#contrast-validation) for the full matrix.
...
Read [Layout](/overview/layout) for breakpoint values and responsive syntax.
