...
| Guidance | Practices                                                                       |
| -------- | ------------------------------------------------------------------------------- |
| Do       | Start with the `xsmall` layout and add values only where the structure changes. |
| Don't    | Repeat every value at every breakpoint.                                         |
| Do       | Keep visual theming in the active theme and use responsive values for layout.   |
| Don't    | Switch to raw colours or typography values in a media query.                    |
