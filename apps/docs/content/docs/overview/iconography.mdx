...
<ExampleBlock
	description="Icons rendered with accessible titles."
	src="icon/basic"
	title="Icon — Basic"
/>
...
<ExampleBlock description="The four size tokens." src="icon/sizes" title="Icon — Sizes" />
...
<ExampleBlock
	description="One size for a group of icons."
	src="icon/size-context"
	title="Icon — Shared size"
/>
...
<ExampleBlock
	description="Icons take the colour of surrounding text."
	src="icon/colours"
	title="Icon — Colour"
/>
...
<ExampleBlock
	description="Hide an icon whose meaning is carried by adjacent text."
	src="icon/decorative"
...
<ExampleBlock
	description="Give a standalone icon an accessible title."
	src="icon/informative"
	title="Icon — Informative"
/>
