...
<div
	style={{
		backgroundColor: vars.color.background.warning.subtle.rest,
		color: vars.color.foreground.warning.rest,
	}}
>
...
<ExampleBlock
	...
	title="Colour — Background and foreground"
	description="Select a role to see its subtle and solid background paired with its foreground."
/>
