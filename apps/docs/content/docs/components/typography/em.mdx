...
Use [Strong](/components/typography/strong) for important text instead of stressed text.

## API

<component-props-table path="packages/@luke-ui/react/src/core/em/em.tsx" name="EmProps" />
