...
<ExampleBlock
	src="heading/basic"
	title="Heading — Basic"
	description="A semantic section heading."
/>
...
Use `'900'` for display headings. Set `color` for a semantic text colour, such as `info` for a
heading that needs to read as informational.
