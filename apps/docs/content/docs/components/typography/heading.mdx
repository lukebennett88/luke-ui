...
Outside `HeadingLevels`, `Heading` falls back to `h2`. Nested contexts cap at `h6`.
...
Do not skip levels, such as an h2 followed by an h4. If you use a screen reader, you can navigate a
