...
<Example component="text" name="typography" />
...
<Example component="text" name="transform" />

## Truncation

<Example component="text" name="truncation" />

## Alignment and numeric glyphs

<Example component="text" name="alignment" />
