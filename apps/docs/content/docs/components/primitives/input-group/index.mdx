...
The icon is decorative and hidden from assistive technology, so it marks a problem without
describing one. Always give an invalid composition an error message. See
