...
source: packages/@luke-ui/react/src/combobox-field/primitive
...
props:
  ...
  - name: ComboboxInputGroupProps
    path: packages/@luke-ui/react/src/combobox-field/primitive/input-group.tsx
...
`ComboboxPopover` portals a desktop-style positioned popover for the listbox. It does not become a
mobile tray. `ComboboxField` owns the modal mobile pattern.
