...
`isPending` keeps the button focusable while preventing another press. It does not add a spinner or
hide the label. Build that cue in children when you use the primitive.
