...
| Guidance | Practices                                                                                               |
| -------- | ------------------------------------------------------------------------------------------------------- |
| Do       | Use a composed field when its input, slots, and layout match the product need.                          |
| Don't    | Recreate a standard text or combobox field from primitives for a minor visual variation.                |
| Do       | Use field primitives when a custom control needs a different structure while retaining field semantics. |
| Don't    | Use a primitive without connecting its label, description, error, and control relationships.            |
