...
<ExampleBlock src="icon-link/basic" layout="centered" title="Icon Link — Basic" />
...
<ExampleBlock src="icon-link/custom-icon" layout="centered" title="Icon Link — Custom icon" />
...
<ExampleBlock src="icon-link/disabled" layout="centered" title="Icon Link — Disabled" />
