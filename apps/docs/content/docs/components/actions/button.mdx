...
| Do                                                                              | Don't                                                                      |
| ------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Use Button to submit, save, open, dismiss, or otherwise change interface state. | Use Button for navigation just because it has a stronger visual treatment. |
| Use Link when activation changes the URL or route.                              | Make a Link perform an in-place action such as submitting a form.          |
