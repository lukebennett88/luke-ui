...
| Guidance | Practices                                                                       |
| -------- | ------------------------------------------------------------------------------- |
| Do       | Use Button to submit, save, open, dismiss, or otherwise change interface state. |
| Don't    | Use Button for navigation just because it has a stronger visual treatment.      |
| Do       | Use Link when activation changes the URL or route.                              |
| Don't    | Make a Link perform an in-place action such as submitting a form.               |
