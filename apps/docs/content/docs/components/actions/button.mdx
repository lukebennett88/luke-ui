...
<ExampleBlock src="button/basic" layout="centered" title="Button: Basic" />
...
<ExampleBlock src="button/content-slots" layout="centered" title="Button: Content slots" />
...
<ExampleBlock src="button/form-action" layout="centered" title="Button: Form action" />
...
<ExampleBlock src="button/pending" layout="centered" title="Button: Pending" />
...
<ExampleBlock src="button/external-pending" layout="centered" title="Button: External pending" />
...
<ExampleBlock src="button/disabled" layout="centered" title="Button: Disabled" />
