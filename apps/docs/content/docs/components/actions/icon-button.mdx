...
<ExampleBlock src="icon-button/basic" layout="centered" title="Icon Button: Basic" />
...
<ExampleBlock src="icon-button/custom-icon" layout="centered" title="Icon Button: Custom icon" />
...
<ExampleBlock src="icon-button/pending" layout="centered" title="Icon Button: Pending" />
...
<ExampleBlock src="icon-button/disabled" layout="centered" title="Icon Button: Disabled" />
