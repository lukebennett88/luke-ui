...
<Example component="text-field" name="basic" />
...
<Example component="text-field" name="required" />
...
<Example component="text-field" name="adornments" />
...
<Example component="text-field" name="sizes" />
