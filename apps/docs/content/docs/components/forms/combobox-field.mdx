...
semantics to its input, trigger, listbox, and validation message. The field shows a focus ring while
the input is focused. Focusing the clear button or the trigger moves that ring onto the action.
