...
Theme authors provide source colours. Luke UI generates the hover and pressed values. Do not author
those states yourself.
...
border for `neutral`. It also adds interactive backgrounds, hover and pressed foregrounds, and
on-solid foregrounds for `info`, `success`, and `warning`.
