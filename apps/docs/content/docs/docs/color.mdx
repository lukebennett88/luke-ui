...
element, use the overlay hover and pressed washes only when the surface underneath should remain
visible. Use a semantic background ramp when the colour communicates intent, selection, validation,
or status.
