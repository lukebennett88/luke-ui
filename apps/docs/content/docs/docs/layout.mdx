...
title: Layout
description:
  Build responsive structure with Box, layout utilities, and inline-size-keyed breakpoints.
---
...
- Hide content at a container inline size with its responsive display prop.
