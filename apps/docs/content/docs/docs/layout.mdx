...
Padding, gap, and margin use value-based spacing keys: `0`, `sp4`, `sp8`, `sp12`, `sp16`, `sp24`,
`sp32`, `sp40`, `sp48`, and `sp64`. Each key matches its pixel value, so `sp16` is 16px. Margin also
