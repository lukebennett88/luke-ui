...
| [AspectRatio](/components/layout/aspect-ratio) | Media should keep a preferred inline-to-block ratio              |
...
breakpoint. Every layout component accepts the same responsive form for the layout props it exposes.
