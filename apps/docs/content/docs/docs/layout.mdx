...
| [ScrollMask](/components/layout/scroll-mask)   | Overflowing content should fade at the scroll edges              |
...
<Cards>
	...
	<Card href="/components/layout/scroll-mask" title="Scroll Mask">
		Mask overflow edges on a keyboard-accessible scrollport.
	</Card>
