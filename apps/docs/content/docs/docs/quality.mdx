...
Read [Contrast validation](/docs/authoring-a-theme#contrast-validation) for the full matrix.
...
Read [Layout](/docs/layout) for breakpoint values and responsive syntax.
