...
<Cards>
	...
	<Card href="/overview/principles" title="Principles">
		Choose the right component, composition boundary, styling API, and responsive behaviour.
	</Card>
...
<Cards>
	<Card href="/components/actions/button" title="Actions">
		Buttons, links, and controls for actions someone takes.
	</Card>
	<Card href="/components/forms/combobox-field" title="Forms">
		Fields and inputs that collect information.
	</Card>
	<Card href="/components/typography/text" title="Typography">
		Text, headings, numerals, and emoji that share one type scale.
	</Card>
...
[token reference](/theming/token-reference) to style a custom element. It does not depend on
component internals.
