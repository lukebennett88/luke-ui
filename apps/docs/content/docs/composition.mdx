...
the task. It handles the intended behaviour, accessibility, and visual treatment together. Compose
from a documented primitive only when a component's props do not fit.
